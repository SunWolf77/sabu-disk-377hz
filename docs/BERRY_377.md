...
Parallel arm: 37.7 / 29 / 33 / 23 Hz (fluid decade). Match **d/λ**, not raw hertz (377 Hz acoustic ≠ 377 MHz microwave).
...
2. Wilson loop / Pancharatnam product on simulated |u(twist)⟩
